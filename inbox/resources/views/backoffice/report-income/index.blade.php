@extends('layouts.backoffice.master', ['title' => 'Laporan Pendapatan'])

@section('content')
    <x-container>
        <div class="col-12">
            <form action="{{ route('backoffice.report-income.filter') }}" method="GET">
                <div class="row">
                    <div class="col-6">
        ...
        @isset($fromDate, $toDate)
            <div class="col-12 my-3">
                <div class="d-flex justify-content-end mb-2">
                    <a href="{{ route('backoffice.report-income.pdf', [$fromDate, $toDate]) }}" class="btn btn-primary">
                ...
                <x-card title="LAPORAN PENDAPATAN" class="card-body p-0">
                    <x-table>
                        <thead>
                            <tr>
