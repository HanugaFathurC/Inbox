...
@section('content')
    ...
    <section class="container my-4 mx-auto px-6 ">
        ...
        <div
            class="lg:p-4 flex flex-row gap-4 flex-cols-4 overflow-x-auto sm:grid sm:grid-cols-2 md:gap-2 lg:gap-4 lg:grid-cols-6">
            <a href="{{ route('product.index') }}"
                ...
                <div>
                    <h2 class="text-base text-gray-700 ">Semua</h2>
                </div>
            </a>
    ...
    <section class="container my-4 mx-auto px-6 ">
        ...
        <div class="my-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
