...
<?php $component->withAttributes([]); ?>
        <div class="col-12">
            <form action="<?php echo e(route('backoffice.report-product-in.filter')); ?>" method="GET">
                <div class="row">
                    <div class="col-6">
                        <?php if (isset($component)) { $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7 = $component; } ?>
<?php $component = App\View\Components\Input::resolve(['title' => 'Tanggal Awal','name' => 'from_date','type' => 'date','placeholder' => '','value' => ''.e($fromDate).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-6">
                        <?php if (isset($component)) { $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7 = $component; } ?>
<?php $component = App\View\Components\Input::resolve(['title' => 'Tanggal Akhir','name' => 'to_date','type' => 'date','placeholder' => '','value' => ''.e($toDate).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Input::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\ButtonSave::resolve(['title' => 'Report Data'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <?php if(isset($fromDate, $toDate)): ?>
            <div class="col-12 my-3">
                <div class="d-flex justify-content-end mb-2">
                    <a href="<?php echo e(route('backoffice.report-product-in.pdf', [$fromDate, $toDate])); ?>" class="btn btn-primary">
...
<?php $component = App\View\Components\Card::resolve(['title' => 'LAPORAN DATA BARANG'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        <thead>
                            <tr>
                                ...
                                <th>Nama Barang</th>
                                <th class="text-right">Kuantitas Barang Masuk</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php $__currentLoopData = $report->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <p><?php echo e($detail->product->name); ?></p>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                    <td class="text-right">
                                        <?php $__currentLoopData = $report->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <p><?php echo e($detail->product->quantity); ?> Item</p>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.backoffice.master', ['title' => 'Laporan Produk Masuk'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\OneDrive\Dokumen\GitHub\IjoLumut\inbox\resources\views/backoffice/report-product-in/index.blade.php ENDPATH**/ ?>