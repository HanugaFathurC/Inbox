...
<?php $component = App\View\Components\CardAction::resolve(['title' => 'Daftar Produk','url' => ''.e(route('backoffice.product-stock.index')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\ButtonModal::resolve(['id' => ''.e($product->id).'','title' => 'Tambah Stok'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Modal::resolve(['id' => ''.e($product->id).'','title' => 'Tambah Stok'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <form action="<?php echo e(route('backoffice.product-stock.update', $product->id)); ?>"
                                            method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <?php if (isset($component)) { $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7 = $component; } ?>
<?php $component = App\View\Components\Input::resolve(['title' => 'Jumlah Stok','name' => 'quantity','type' => 'number','placeholder' => '','value' => ''.e($product->quantity).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layouts.backoffice.master', ['title' => 'Stok Produk'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\OneDrive\Dokumen\GitHub\IjoLumut\inbox\resources\views/backoffice/product-stock/index.blade.php ENDPATH**/ ?>